...
![](./media/periodika_oznacit_radu/image1.png){.bordered}

Rozložení obrazovek s využitím **Tabulky**:

![](./media/periodika_oznacit_radu/image2.png){.bordered}
...
![](./media/periodika_oznacit_radu/image3.png){.bordered}
...
![](./media/periodika_oznacit_radu/image4.png){.bordered}

Vyberte skeny, na které chcete šablonu aplikovat (např. strany 7-18).

![](./media/periodika_oznacit_radu/image5.png){.bordered}
...
![](./media/periodika_oznacit_radu/image6.png){.bordered}
